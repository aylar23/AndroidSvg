...
import com.aylar.svgandroid.svg.CSSParser.Ruleset;
import com.aylar.svgandroid.svg.PreserveAspectRatio;
import com.aylar.svgandroid.svg.RenderOptions;
import com.aylar.svgandroid.svg.SVGAndroidRenderer;
...
public class SVG
{
   ...
   {
      SVGParser  parser = new SVGParser();
      return parser.parse(new ByteArrayInputStream(svg.getBytes()), false);
   }
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public Picture  renderToPicture(com.aylar.svgandroid.svg.RenderOptions renderOptions)
   {
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public Picture  renderToPicture(int widthInPixels, int heightInPixels, com.aylar.svgandroid.svg.RenderOptions renderOptions)
   {
      Picture  picture = new Picture();
      Canvas   canvas = picture.beginRecording(widthInPixels, heightInPixels);

      if (renderOptions == null || renderOptions.viewPort == null) {
         renderOptions = (renderOptions == null) ? new com.aylar.svgandroid.svg.RenderOptions() : new com.aylar.svgandroid.svg.RenderOptions(renderOptions);
   ...
   {
      com.aylar.svgandroid.svg.RenderOptions renderOptions = new com.aylar.svgandroid.svg.RenderOptions();
   ...
   {
      renderToCanvas(canvas, (com.aylar.svgandroid.svg.RenderOptions) null);
   }
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public void  renderToCanvas(Canvas canvas, com.aylar.svgandroid.svg.RenderOptions renderOptions)
   {
      if (renderOptions == null)
         renderOptions = new com.aylar.svgandroid.svg.RenderOptions();
   ...
   {
      renderToCanvas(canvas, com.aylar.svgandroid.svg.RenderOptions.create().view(viewId));
   }
   ...
   {
      com.aylar.svgandroid.svg.RenderOptions renderOptions = RenderOptions.create().view(viewId);
    ...
    * documentation for {@link com.aylar.svgandroid.svg.PreserveAspectRatio} for more information
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public void  setDocumentPreserveAspectRatio(com.aylar.svgandroid.svg.PreserveAspectRatio preserveAspectRatio)
   {
      if (this.rootElement == null)
         throw new IllegalArgumentException("SVG document is empty");
    ...
    * element in the form of an {@link com.aylar.svgandroid.svg.PreserveAspectRatio} object.
    * 
    * @return the preserveAspectRatio setting of the document's root {@code <svg>} element.
    * @throws IllegalArgumentException if there is no current SVG document loaded.
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public com.aylar.svgandroid.svg.PreserveAspectRatio getDocumentPreserveAspectRatio()
   {
      if (this.rootElement == null)
         throw new IllegalArgumentException("SVG document is empty");
  ...
  public List<com.aylar.svgandroid.svg.CSSParser.Rule>  getCSSRules()
   {
  ...
  public void clearRenderCSSRules()
   {
      this.cssRules.removeFromSource(com.aylar.svgandroid.svg.CSSParser.Source.RenderOptions);
   }
