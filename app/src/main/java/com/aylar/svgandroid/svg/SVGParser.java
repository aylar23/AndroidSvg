...
import com.aylar.svgandroid.svg.CSSParser;
import com.aylar.svgandroid.svg.CSSParser.MediaType;
import com.aylar.svgandroid.svg.IntegerParser;
import com.aylar.svgandroid.svg.LibConfig;
import com.aylar.svgandroid.svg.NumberParser;
import com.aylar.svgandroid.svg.PreserveAspectRatio;
import com.aylar.svgandroid.svg.SVG;
import com.aylar.svgandroid.svg.SVG.Box;
import com.aylar.svgandroid.svg.SVG.CSSClipRect;
import com.aylar.svgandroid.svg.SVG.Colour;
import com.aylar.svgandroid.svg.SVG.CurrentColor;
import com.aylar.svgandroid.svg.SVG.GradientSpread;
import com.aylar.svgandroid.svg.SVG.Length;
import com.aylar.svgandroid.svg.SVG.PaintReference;
import com.aylar.svgandroid.svg.SVG.Style;
import com.aylar.svgandroid.svg.SVG.Style.RenderQuality;
import com.aylar.svgandroid.svg.SVG.Style.TextDecoration;
import com.aylar.svgandroid.svg.SVG.Style.TextDirection;
import com.aylar.svgandroid.svg.SVG.Style.VectorEffect;
import com.aylar.svgandroid.svg.SVG.SvgElementBase;
import com.aylar.svgandroid.svg.SVG.SvgObject;
import com.aylar.svgandroid.svg.SVG.SvgPaint;
import com.aylar.svgandroid.svg.SVG.TextChild;
import com.aylar.svgandroid.svg.SVG.TextPositionedContainer;
import com.aylar.svgandroid.svg.SVG.TextRoot;
import com.aylar.svgandroid.svg.SVG.Unit;
import com.aylar.svgandroid.svg.SVGParseException;
...
class SVGParser
{
   ...
   // SVG parser
   private com.aylar.svgandroid.svg.SVG svgDocument = null;
   private com.aylar.svgandroid.svg.SVG.SvgContainer  currentElement = null;
   ...
   private static class FontWeightKeywords {
      ...
      static {
         fontWeightKeywords.put("normal", com.aylar.svgandroid.svg.SVG.Style.FONT_WEIGHT_NORMAL);
         fontWeightKeywords.put("bold", com.aylar.svgandroid.svg.SVG.Style.FONT_WEIGHT_BOLD);
         fontWeightKeywords.put("bolder", com.aylar.svgandroid.svg.SVG.Style.FONT_WEIGHT_BOLDER);
         fontWeightKeywords.put("lighter", com.aylar.svgandroid.svg.SVG.Style.FONT_WEIGHT_LIGHTER);
   ...
   private static class AspectRatioKeywords {
      private static final Map<String, com.aylar.svgandroid.svg.PreserveAspectRatio.Alignment> aspectRatioKeywords = new HashMap<>(10);
      static {
         aspectRatioKeywords.put(NONE, com.aylar.svgandroid.svg.PreserveAspectRatio.Alignment.none);
         aspectRatioKeywords.put("xMinYMin", com.aylar.svgandroid.svg.PreserveAspectRatio.Alignment.xMinYMin);
         aspectRatioKeywords.put("xMidYMin", com.aylar.svgandroid.svg.PreserveAspectRatio.Alignment.xMidYMin);
         aspectRatioKeywords.put("xMaxYMin", com.aylar.svgandroid.svg.PreserveAspectRatio.Alignment.xMaxYMin);
         aspectRatioKeywords.put("xMinYMid", com.aylar.svgandroid.svg.PreserveAspectRatio.Alignment.xMinYMid);
         aspectRatioKeywords.put("xMidYMid", com.aylar.svgandroid.svg.PreserveAspectRatio.Alignment.xMidYMid);
         aspectRatioKeywords.put("xMaxYMid", com.aylar.svgandroid.svg.PreserveAspectRatio.Alignment.xMaxYMid);
         aspectRatioKeywords.put("xMinYMax", com.aylar.svgandroid.svg.PreserveAspectRatio.Alignment.xMinYMax);
         aspectRatioKeywords.put("xMidYMax", com.aylar.svgandroid.svg.PreserveAspectRatio.Alignment.xMidYMax);
         aspectRatioKeywords.put("xMaxYMax", com.aylar.svgandroid.svg.PreserveAspectRatio.Alignment.xMaxYMax);
      }

      static com.aylar.svgandroid.svg.PreserveAspectRatio.Alignment get(String aspectRatio) {
   ...
   com.aylar.svgandroid.svg.SVG parse(InputStream is, boolean enableInternalEntities) throws com.aylar.svgandroid.svg.SVGParseException
   {
   ...
   private void parseUsingXmlPullParser(InputStream is, boolean enableInternalEntities) throws com.aylar.svgandroid.svg.SVGParseException
   {
      try
      {
...
Log.d(TAG,"PROC INSTR: "+parser.getText());
      ...
      {
         throw new com.aylar.svgandroid.svg.SVGParseException("XML parser problem", e);
      }
      catch (IOException e)
      {
         throw new com.aylar.svgandroid.svg.SVGParseException("Stream error", e);
      }
   }
   ...
   private void parseUsingSAX(InputStream is) throws com.aylar.svgandroid.svg.SVGParseException
   {
      ...
      {
         throw new com.aylar.svgandroid.svg.SVGParseException("SVG parse error", e);
      }
      catch (IOException e)
      {
         throw new com.aylar.svgandroid.svg.SVGParseException("Stream error", e);
   ...
   {
      SVGParser.this.svgDocument = new com.aylar.svgandroid.svg.SVG();
   }


   private void startElement(String uri, String localName, String qName, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      if (ignoring) {
         ignoreDepth++;
         return;
   ...
   private void  text(String characters) throws com.aylar.svgandroid.svg.SVGParseException
   {
      if (ignoring)
         return;
      ...
      else if (currentElement instanceof com.aylar.svgandroid.svg.SVG.TextContainer)
      {
   ...
   private void  text(char[] ch, int start, int length) throws com.aylar.svgandroid.svg.SVGParseException
   {
      if (ignoring)
         return;
   ...
   private void  appendToTextContainer(String characters) throws com.aylar.svgandroid.svg.SVGParseException
   {
      ...
      com.aylar.svgandroid.svg.SVG.SvgConditionalContainer  parent = (com.aylar.svgandroid.svg.SVG.SvgConditionalContainer) currentElement;
      int  numOlderSiblings = parent.children.size();
      com.aylar.svgandroid.svg.SVG.SvgObject  previousSibling = (numOlderSiblings == 0) ? null : parent.children.get(numOlderSiblings-1);
      if (previousSibling instanceof com.aylar.svgandroid.svg.SVG.TextSequence) {
         // Last sibling was a TextSequence also, so merge them.
         ((com.aylar.svgandroid.svg.SVG.TextSequence) previousSibling).text += characters;
      } else {
         // Add a new TextSequence to the child node list
         currentElement.addChild(new com.aylar.svgandroid.svg.SVG.TextSequence( characters ));
      }
   }


   private void  endElement(String uri, String localName, String qName) throws com.aylar.svgandroid.svg.SVGParseException
   {
      if (ignoring) {
         if (--ignoreDepth == 0) {
            ignoring = false;
   ...
   {
      // Dump document
      if (com.aylar.svgandroid.svg.LibConfig.DEBUG)
   ...
   {
      if (instruction.equals(XML_STYLESHEET_PROCESSING_INSTRUCTION) && com.aylar.svgandroid.svg.SVG.getFileResolver() != null)
      {
         // If a "type" is specified, make sure it is the CSS type
         String  attr = attributes.get(XML_STYLESHEET_ATTR_TYPE);
         if (attr != null && !com.aylar.svgandroid.svg.CSSParser.CSS_MIME_TYPE.equals(attributes.get("type")))
            return;
         ...
         if (attr != null)
         {
            String  css = com.aylar.svgandroid.svg.SVG.getFileResolver().resolveCSSStyleSheet(attr);
            if (css == null)
               return;
   ...
   private void  dumpNode(com.aylar.svgandroid.svg.SVG.SvgObject elem, String indent)
   {
      Log.d(TAG, indent+elem);
      if (elem instanceof com.aylar.svgandroid.svg.SVG.SvgConditionalContainer) {
         indent = indent+"  ";
         for (com.aylar.svgandroid.svg.SVG.SvgObject child: ((com.aylar.svgandroid.svg.SVG.SvgConditionalContainer) elem).children) {
   ...
   private void  svg(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<svg>");

      com.aylar.svgandroid.svg.SVG.Svg  obj = new com.aylar.svgandroid.svg.SVG.Svg();
   ...
   private void  parseAttributesSVG(com.aylar.svgandroid.svg.SVG.Svg obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
         ...
         switch (SVGAttr.fromString(attributes.getLocalName(i)))
         {
            ...
            case width:
               ...
               if (obj.width.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <svg> element. width cannot be negative");
               break;
            case height:
               obj.height = parseLength(val);
               if (obj.height.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <svg> element. height cannot be negative");
               break;
            case version:
               obj.version = val;
               break;
   ...
   private void  g(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<g>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Group  obj = new com.aylar.svgandroid.svg.SVG.Group();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  defs(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<defs>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Defs  obj = new com.aylar.svgandroid.svg.SVG.Defs();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  use(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<use>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Use  obj = new com.aylar.svgandroid.svg.SVG.Use();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesUse(com.aylar.svgandroid.svg.SVG.Use obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
         switch (SVGAttr.fromString(attributes.getLocalName(i)))
         {
            ...
            case width:
               obj.width = parseLength(val);
               if (obj.width.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <use> element. width cannot be negative");
               break;
            case height:
               obj.height = parseLength(val);
               if (obj.height.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <use> element. height cannot be negative");
               break;
            case href:
   ...
   private void  image(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<image>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Image  obj = new com.aylar.svgandroid.svg.SVG.Image();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesImage(com.aylar.svgandroid.svg.SVG.Image obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  path(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<path>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Path  obj = new com.aylar.svgandroid.svg.SVG.Path();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesPath(com.aylar.svgandroid.svg.SVG.Path obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
         switch (SVGAttr.fromString(attributes.getLocalName(i)))
         {
            ...
            case pathLength:
               ...
               if (obj.pathLength < 0f)
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <path> element. pathLength cannot be negative");
               break;
            default:
               break;
         }
   ...
   private void  rect(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<rect>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Rect  obj = new com.aylar.svgandroid.svg.SVG.Rect();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesRect(com.aylar.svgandroid.svg.SVG.Rect obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
         switch (SVGAttr.fromString(attributes.getLocalName(i)))
         {
            ...
            case width:
               obj.width = parseLength(val);
               if (obj.width.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <rect> element. width cannot be negative");
               break;
            case height:
               obj.height = parseLength(val);
               if (obj.height.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <rect> element. height cannot be negative");
               break;
            case rx:
               obj.rx = parseLength(val);
               if (obj.rx.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <rect> element. rx cannot be negative");
               break;
            case ry:
               obj.ry = parseLength(val);
               if (obj.ry.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <rect> element. ry cannot be negative");
               break;
            default:
               break;
         }
   ...
   private void  circle(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<circle>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Circle  obj = new com.aylar.svgandroid.svg.SVG.Circle();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesCircle(com.aylar.svgandroid.svg.SVG.Circle obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
         switch (SVGAttr.fromString(attributes.getLocalName(i)))
         {
            ...
            case r:
               ...
               if (obj.r.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <circle> element. r cannot be negative");
               break;
            default:
               break;
         }
   ...
   private void  ellipse(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<ellipse>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Ellipse  obj = new com.aylar.svgandroid.svg.SVG.Ellipse();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesEllipse(com.aylar.svgandroid.svg.SVG.Ellipse obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
         switch (SVGAttr.fromString(attributes.getLocalName(i)))
         {
            ...
            case rx:
               obj.rx = parseLength(val);
               if (obj.rx.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <ellipse> element. rx cannot be negative");
               break;
            case ry:
               obj.ry = parseLength(val);
               if (obj.ry.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <ellipse> element. ry cannot be negative");
               break;
            default:
               break;
         }
   ...
   private void  line(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<line>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Line  obj = new com.aylar.svgandroid.svg.SVG.Line();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesLine(com.aylar.svgandroid.svg.SVG.Line obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  polyline(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<polyline>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.PolyLine  obj = new com.aylar.svgandroid.svg.SVG.PolyLine();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
    ...
    */
   private void  parseAttributesPolyLine(com.aylar.svgandroid.svg.SVG.PolyLine obj, Attributes attributes, String tag) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         if (SVGAttr.fromString(attributes.getLocalName(i)) == SVGAttr.points)
         {
            ...
            while (!scan.empty()) {
               ...
               if (Float.isNaN(x))
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <"+tag+"> points attribute. Non-coordinate content found in list.");
               scan.skipCommaWhitespace();
               float y = scan.nextFloat();
               if (Float.isNaN(y))
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <"+tag+"> points attribute. There should be an even number of coordinates.");
               scan.skipCommaWhitespace();
               points.add(x);
               points.add(y);
            }
   ...
   private void  polygon(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<polygon>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Polygon  obj = new com.aylar.svgandroid.svg.SVG.Polygon();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  text(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<text>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Text  obj = new com.aylar.svgandroid.svg.SVG.Text();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesTextPosition(TextPositionedContainer obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  tspan(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<tspan>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      if (!(currentElement instanceof com.aylar.svgandroid.svg.SVG.TextContainer))
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. <tspan> elements are only valid inside <text> or other <tspan> elements.");
      com.aylar.svgandroid.svg.SVG.TSpan  obj = new com.aylar.svgandroid.svg.SVG.TSpan();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  tref(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<tref>");
      ...
      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      if (!(currentElement instanceof com.aylar.svgandroid.svg.SVG.TextContainer))
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. <tref> elements are only valid inside <text> or <tspan> elements.");
      com.aylar.svgandroid.svg.SVG.TRef  obj = new com.aylar.svgandroid.svg.SVG.TRef();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesTRef(com.aylar.svgandroid.svg.SVG.TRef obj, Attributes attributes)
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  zwitch(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<switch>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Switch  obj = new com.aylar.svgandroid.svg.SVG.Switch();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesConditional(com.aylar.svgandroid.svg.SVG.SvgConditional obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  symbol(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<symbol>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Symbol  obj = new com.aylar.svgandroid.svg.SVG.Symbol();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  marker(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<marker>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Marker  obj = new com.aylar.svgandroid.svg.SVG.Marker();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesMarker(com.aylar.svgandroid.svg.SVG.Marker obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
         switch (SVGAttr.fromString(attributes.getLocalName(i)))
         {
            ...
            case markerWidth:
               ...
               if (obj.markerWidth.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <marker> element. markerWidth cannot be negative");
               break;
            case markerHeight:
               obj.markerHeight = parseLength(val);
               if (obj.markerHeight.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <marker> element. markerHeight cannot be negative");
               break;
            case markerUnits:
               if ("strokeWidth".equals(val)) {
                  ...
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid value for attribute markerUnits");
               } 
               break;
            case orient:
               if ("auto".equals(val)) {
   ...
   private void  linearGradient(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<linearGradient>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.SvgLinearGradient  obj = new com.aylar.svgandroid.svg.SVG.SvgLinearGradient();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesGradient(com.aylar.svgandroid.svg.SVG.GradientElement obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
         switch (SVGAttr.fromString(attributes.getLocalName(i)))
         {
            case gradientUnits:
               if ("objectBoundingBox".equals(val)) {
                  ...
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid value for attribute gradientUnits");
               } 
               break;
            ...
            case spreadMethod:
               ...
               {
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid spreadMethod attribute. \""+val+"\" is not a valid value.");
               }
               break;
            case href:
               if ("".equals(attributes.getURI(i)) || XLINK_NAMESPACE.equals(attributes.getURI(i)))
   ...
   private void  parseAttributesLinearGradient(com.aylar.svgandroid.svg.SVG.SvgLinearGradient obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  radialGradient(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<radialGradient>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.SvgRadialGradient  obj = new com.aylar.svgandroid.svg.SVG.SvgRadialGradient();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesRadialGradient(com.aylar.svgandroid.svg.SVG.SvgRadialGradient obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
         switch (SVGAttr.fromString(attributes.getLocalName(i)))
         {
            ...
            case r:
               obj.r = parseLength(val);
               if (obj.r.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <radialGradient> element. r cannot be negative");
               break;
            case fx:
   ...
   private void  stop(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<stop>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      if (!(currentElement instanceof com.aylar.svgandroid.svg.SVG.GradientElement))
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. <stop> elements are only valid inside <linearGradient> or <radialGradient> elements.");
      com.aylar.svgandroid.svg.SVG.Stop  obj = new com.aylar.svgandroid.svg.SVG.Stop();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesStop(com.aylar.svgandroid.svg.SVG.Stop obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private Float  parseGradientOffset(String val) throws com.aylar.svgandroid.svg.SVGParseException
   {
      if (val.length() == 0)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid offset value in <stop> (empty string)");
      int      end = val.length();
      ...
      {
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid offset value in <stop>: "+val, e);
      }
   }
   ...
   private void  solidColor(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<solidColor>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.SolidColor  obj = new com.aylar.svgandroid.svg.SVG.SolidColor();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  clipPath(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<clipPath>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.ClipPath  obj = new com.aylar.svgandroid.svg.SVG.ClipPath();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesClipPath(com.aylar.svgandroid.svg.SVG.ClipPath obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
         switch (SVGAttr.fromString(attributes.getLocalName(i)))
         {
            case clipPathUnits:
               if ("objectBoundingBox".equals(val)) {
                  ...
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid value for attribute clipPathUnits");
               }
               break;
            default:
               break;
   ...
   private void textPath(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<textPath>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.TextPath  obj = new com.aylar.svgandroid.svg.SVG.TextPath();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesTextPath(com.aylar.svgandroid.svg.SVG.TextPath obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void pattern(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<pattern>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Pattern  obj = new com.aylar.svgandroid.svg.SVG.Pattern();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesPattern(com.aylar.svgandroid.svg.SVG.Pattern obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
         switch (SVGAttr.fromString(attributes.getLocalName(i)))
         {
            case patternUnits:
               if ("objectBoundingBox".equals(val)) {
                  ...
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid value for attribute patternUnits");
               } 
               break;
            case patternContentUnits:
               if ("objectBoundingBox".equals(val)) {
                  ...
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid value for attribute patternContentUnits");
               } 
               break;
            ...
            case width:
               obj.width = parseLength(val);
               if (obj.width.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <pattern> element. width cannot be negative");
               break;
            case height:
               obj.height = parseLength(val);
               if (obj.height.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <pattern> element. height cannot be negative");
               break;
            case href:
               if ("".equals(attributes.getURI(i)) || XLINK_NAMESPACE.equals(attributes.getURI(i)))
                  obj.href = val;
   ...
   private void  view(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<view>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.View  obj = new com.aylar.svgandroid.svg.SVG.View();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesConditional(obj, attributes);
   ...
   private void mask(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<mask>");

      if (currentElement == null)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid document. Root element must be <svg>");
      com.aylar.svgandroid.svg.SVG.Mask  obj = new com.aylar.svgandroid.svg.SVG.Mask();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesMask(com.aylar.svgandroid.svg.SVG.Mask obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
         switch (SVGAttr.fromString(attributes.getLocalName(i)))
         {
            case maskUnits:
               if ("objectBoundingBox".equals(val)) {
                  ...
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid value for attribute maskUnits");
               } 
               break;
            case maskContentUnits:
               if ("objectBoundingBox".equals(val)) {
                  ...
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid value for attribute maskContentUnits");
               } 
               break;
            case x:
               obj.x = parseLength(val);
            ...
            case width:
               obj.width = parseLength(val);
               if (obj.width.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <mask> element. width cannot be negative");
               break;
            case height:
               obj.height = parseLength(val);
               if (obj.height.isNegative())
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid <mask> element. height cannot be negative");
               break;
            default:
               break;
         }
   ...
   static class TextScanner
   {
      ...
      private com.aylar.svgandroid.svg.NumberParser numberParser = new com.aylar.svgandroid.svg.NumberParser();
   ...
   private void  parseAttributesCore(SvgElementBase obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         ...
         if (qname.equals("id") || qname.equals("xml:id"))
         {
            ...
            if ("default".equals(val)) {
               ...
               throw new com.aylar.svgandroid.svg.SVGParseException("Invalid value for \"xml:space\" attribute: "+val);
            }
            break;
         }
      }
    ...
    */
   private void  parseAttributesStyle(SvgElementBase obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String  val = attributes.getValue(i).trim();
         ...
         switch (SVGAttr.fromString(attributes.getLocalName(i)))
         {
            ...
            case CLASS:
               obj.classNames = com.aylar.svgandroid.svg.CSSParser.parseClassAttribute(val);
               break;
   ...
   static void  processStyleProperty(Style style, String localName, String val)// throws SVGParseException
   {
      ...
      switch (SVGAttr.fromString(localName))
      {
         case fill:
            ...
            if (style.fill != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_FILL;
            break;

         case fill_rule:
            style.fillRule = parseFillRule(val);
            if (style.fillRule != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_FILL_RULE;
            break;

         case fill_opacity:
            style.fillOpacity = parseOpacity(val);
            if (style.fillOpacity != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_FILL_OPACITY;
            break;

         case stroke:
            style.stroke = parsePaintSpecifier(val);
            if (style.stroke != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_STROKE;
            break;

         case stroke_opacity:
            style.strokeOpacity = parseOpacity(val);
            if (style.strokeOpacity != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_STROKE_OPACITY;
            break;

         case stroke_width:
            try {
               style.strokeWidth = parseLength(val);
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_STROKE_WIDTH;
            } catch (com.aylar.svgandroid.svg.SVGParseException e) {
               // Do nothing
            }
            break;
         ...
         case stroke_linecap:
            ...
            if (style.strokeLineCap != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_STROKE_LINECAP;
            break;

         case stroke_linejoin:
            style.strokeLineJoin = parseStrokeLineJoin(val);
            if (style.strokeLineJoin != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_STROKE_LINEJOIN;
            break;

         case stroke_miterlimit:
            try {
               style.strokeMiterLimit = parseFloat(val);
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_STROKE_MITERLIMIT;
            } catch (com.aylar.svgandroid.svg.SVGParseException e) {
               // Do nothing
            }
            break;
         ...
         case stroke_dasharray:
            if (NONE.equals(val)) {
               ...
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_STROKE_DASHARRAY;
               break;
            }
         ...
         case stroke_dashoffset:
            try {
               ...
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_STROKE_DASHOFFSET;
            } catch (com.aylar.svgandroid.svg.SVGParseException e) {
               // Do nothing
            }
            break;
         ...
         case opacity:
            ...
            style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_OPACITY;
            break;

         case color:
            try {
               style.color = parseColour(val);
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_COLOR;
            } catch (com.aylar.svgandroid.svg.SVGParseException e) {
               // Do nothing
            }
            break;
         ...
         case font_family:
            ...
            if (style.fontFamily != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_FONT_FAMILY;
            break;

         case font_size:
            style.fontSize = parseFontSize(val);
            if (style.fontSize != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_FONT_SIZE;
            break;

         case font_weight:
            style.fontWeight = parseFontWeight(val);
            if (style.fontWeight != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_FONT_WEIGHT;
            break;

         case font_style:
            style.fontStyle = parseFontStyle(val);
            if (style.fontStyle != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_FONT_STYLE;
            break;

         case text_decoration:
            style.textDecoration = parseTextDecoration(val);
            if (style.textDecoration != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_TEXT_DECORATION;
            break;

         case direction:
            style.direction = parseTextDirection(val);
            if (style.direction != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_DIRECTION;
            break;

         case text_anchor:
            style.textAnchor = parseTextAnchor(val);
            if (style.textAnchor != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_TEXT_ANCHOR;
            break;

         case overflow:
            style.overflow = parseOverflow(val);
            if (style.overflow != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_OVERFLOW;
            break;
         ...
         case marker:
            ...
            style.specifiedFlags |= (com.aylar.svgandroid.svg.SVG.SPECIFIED_MARKER_START | com.aylar.svgandroid.svg.SVG.SPECIFIED_MARKER_MID | com.aylar.svgandroid.svg.SVG.SPECIFIED_MARKER_END);
            break;

         case marker_start:
            style.markerStart = parseFunctionalIRI(val, localName);
            style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_MARKER_START;
            break;

         case marker_mid:
            style.markerMid = parseFunctionalIRI(val, localName);
            style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_MARKER_MID;
            break;

         case marker_end:
            style.markerEnd = parseFunctionalIRI(val, localName);
            style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_MARKER_END;
            break;
         ...
         case display:
            ...
            style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_DISPLAY;
            break;
         ...
         case visibility:
            ...
            style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_VISIBILITY;
            break;
         ...
         case stop_color:
            ...
            style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_STOP_COLOR;
            break;

         case stop_opacity:
            style.stopOpacity = parseOpacity(val);
            style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_STOP_OPACITY;
            break;

         case clip:
            style.clip = parseClip(val);
            if (style.clip != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_CLIP;
            break;

         case clip_path:
            style.clipPath = parseFunctionalIRI(val, localName);
            style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_CLIP_PATH;
            break;

         case clip_rule:
            style.clipRule = parseFillRule(val);
            style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_CLIP_RULE;
            break;

         case mask:
            style.mask = parseFunctionalIRI(val, localName);
            style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_MASK;
            break;
         ...
         case solid_color:
            ...
            style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_SOLID_COLOR;
            break;

         case solid_opacity:
            style.solidOpacity = parseOpacity(val);
            style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_SOLID_OPACITY;
            break;
         ...
         case viewport_fill:
            ...
            style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_VIEWPORT_FILL;
            break;

         case viewport_fill_opacity:
            style.viewportFillOpacity = parseOpacity(val);
            style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_VIEWPORT_FILL_OPACITY;
            break;

         case vector_effect:
            style.vectorEffect = parseVectorEffect(val);
            if (style.vectorEffect != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_VECTOR_EFFECT;
            break;

         case image_rendering:
            style.imageRendering = parseRenderQuality(val);
            if (style.imageRendering != null)
               style.specifiedFlags |= com.aylar.svgandroid.svg.SVG.SPECIFIED_IMAGE_RENDERING;
            break;
   ...
   private void  parseAttributesViewBox(com.aylar.svgandroid.svg.SVG.SvgViewBoxContainer obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  parseAttributesTransform(com.aylar.svgandroid.svg.SVG.HasTransform obj, Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
   ...
   private Matrix  parseTransformList(String val) throws com.aylar.svgandroid.svg.SVGParseException
   {
      ...
      while (!scan.empty())
      {
         ...
         if (cmd == null)
            throw new com.aylar.svgandroid.svg.SVGParseException("Bad transform function encountered in transform list: "+val);
         ...
         switch (cmd) {
            case "matrix":
               ...
               if (Float.isNaN(f) || !scan.consume(')'))
                  throw new com.aylar.svgandroid.svg.SVGParseException("Invalid transform list: " + val);
            ...
            default:
               throw new com.aylar.svgandroid.svg.SVGParseException("Invalid transform list fn: " + cmd + ")");
         }
    ...
    */
   static Length  parseLength(String val) throws com.aylar.svgandroid.svg.SVGParseException
   {
      if (val.length() == 0)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid length value (empty string)");
      int   end = val.length();
      Unit  unit = Unit.px;
      ...
      if (lastChar == '%') {
         ...
         try {
            ...
            throw new com.aylar.svgandroid.svg.SVGParseException("Invalid length unit specifier: "+val);
         }
      }
      try
      {
      ...
      {
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid length value: "+val, e);
      }
   }
    ...
    */
   private static List<Length>  parseLengthList(String val) throws com.aylar.svgandroid.svg.SVGParseException
   {
      if (val.length() == 0)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid length list (empty string)");
      ...
      while (!scan.empty())
      {
         ...
         if (Float.isNaN(scalar))
            throw new com.aylar.svgandroid.svg.SVGParseException("Invalid length list value: "+scan.ahead());
    ...
    */
   private static float  parseFloat(String val) throws com.aylar.svgandroid.svg.SVGParseException
   {
      int  len = val.length();
      if (len == 0)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid float value (empty string)");
      return parseFloat(val, 0, len);
   }

   private static float  parseFloat(String val, int offset, int len) throws com.aylar.svgandroid.svg.SVGParseException
   {
      com.aylar.svgandroid.svg.NumberParser np = new com.aylar.svgandroid.svg.NumberParser();
      float  num = np.parseNumber(val, offset, len);
      if (!Float.isNaN(num)) {
         return num;
      } else {
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid float value: "+val);
      }
   }
    ...
    */
   private static Box  parseViewBox(String val) throws com.aylar.svgandroid.svg.SVGParseException
   {
      TextScanner scan = new TextScanner(val);
      scan.skipWhitespace();
      ...
      if (Float.isNaN(minX) || Float.isNaN(minY) || Float.isNaN(width) || Float.isNaN(height))
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid viewBox definition - should have four numbers");
      if (width < 0)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid viewBox. width cannot be negative");
      if (height < 0)
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid viewBox. height cannot be negative");

      return new com.aylar.svgandroid.svg.SVG.Box(minX, minY, width, height);
   }
    ...
    */
   private static void  parsePreserveAspectRatio(com.aylar.svgandroid.svg.SVG.SvgPreserveAspectRatioContainer obj, String val) throws com.aylar.svgandroid.svg.SVGParseException
   {
      obj.preserveAspectRatio = parsePreserveAspectRatio(val);
   }


   static com.aylar.svgandroid.svg.PreserveAspectRatio parsePreserveAspectRatio(String val) throws com.aylar.svgandroid.svg.SVGParseException
   {
      TextScanner scan = new TextScanner(val);
      scan.skipWhitespace();
      ...
      com.aylar.svgandroid.svg.PreserveAspectRatio.Alignment  align = AspectRatioKeywords.get(word);
      com.aylar.svgandroid.svg.PreserveAspectRatio.Scale      scale = null;
      ...
      if (!scan.empty()) {
         ...
         switch (meetOrSlice) {
            case "meet":
               scale = com.aylar.svgandroid.svg.PreserveAspectRatio.Scale.meet; break;
            case "slice":
               scale = com.aylar.svgandroid.svg.PreserveAspectRatio.Scale.slice; break;
            default:
               throw new com.aylar.svgandroid.svg.SVGParseException("Invalid preserveAspectRatio definition: " + val);
         }
      }
    ...
    */
   private static Colour  parseColour(String val) throws com.aylar.svgandroid.svg.SVGParseException
   {
      if (val.charAt(0) == '#')
      {
         com.aylar.svgandroid.svg.IntegerParser ip = com.aylar.svgandroid.svg.IntegerParser.parseHex(val, 1, val.length());
         if (ip == null) {
            throw new com.aylar.svgandroid.svg.SVGParseException("Bad hex colour value: "+val);
         }
      ...
      if (isRGBA || valLowerCase.startsWith("rgb("))
      {
         ...
         if (isRGBA) {
            ...
            if (Float.isNaN(alpha) || !scan.consume(')'))
               throw new com.aylar.svgandroid.svg.SVGParseException("Bad rgba() colour value: "+val);
            return new Colour( clamp255(alpha * 256)<<24 | clamp255(red)<<16 | clamp255(green)<<8 | clamp255(blue) );
         } else {
            scan.skipWhitespace();
            if (Float.isNaN(blue) || !scan.consume(')'))
               throw new com.aylar.svgandroid.svg.SVGParseException("Bad rgb() colour value: "+val);
      ...
      else
      {
         ...
         if (isHSLA || valLowerCase.startsWith("hsl("))
         {
            ...
            if (isHSLA) {
               ...
               scan.skipWhitespace();
               if (Float.isNaN(alpha) || !scan.consume(')'))
                  throw new com.aylar.svgandroid.svg.SVGParseException("Bad hsla() colour value: "+val);
               return new Colour( clamp255(alpha * 256)<<24 | hslToRgb(hue, saturation, lightness) );
            } else {
               scan.skipWhitespace();
               if (Float.isNaN(lightness) || !scan.consume(')'))
                  throw new com.aylar.svgandroid.svg.SVGParseException("Bad hsl() colour value: "+val);
   ...
   private static Colour  parseColourKeyword(String nameLowerCase) throws com.aylar.svgandroid.svg.SVGParseException
   {
      Integer  col = ColourKeywords.get(nameLowerCase);
      if (col == null) {
         throw new com.aylar.svgandroid.svg.SVGParseException("Invalid colour keyword: "+nameLowerCase);
      }
   ...
   private static void  parseFont(Style style, String val)
   {
      ...
      style.specifiedFlags |= (com.aylar.svgandroid.svg.SVG.SPECIFIED_FONT_FAMILY | com.aylar.svgandroid.svg.SVG.SPECIFIED_FONT_SIZE | com.aylar.svgandroid.svg.SVG.SPECIFIED_FONT_WEIGHT | com.aylar.svgandroid.svg.SVG.SPECIFIED_FONT_STYLE);
   }
   ...
   private static TextDecoration  parseTextDecoration(String val)
   {
      switch (val)
      {
         ...
         case "blink":        return TextDecoration.Blink;
         default:             return null;
      }
   }
   ...
   private static VectorEffect  parseVectorEffect(String val)
   {
      switch (val)
      {
         case NONE:                 return VectorEffect.None;
         case "non-scaling-stroke": return VectorEffect.NonScalingStroke;
         default:                   return null;
      }
   }
   ...
   private static com.aylar.svgandroid.svg.SVG.PathDefinition  parsePath(String val)
   {
      TextScanner  scan = new TextScanner(val);
      ...
      com.aylar.svgandroid.svg.SVG.PathDefinition  path = new SVG.PathDefinition();
   ...
   private void  style(Attributes attributes) throws com.aylar.svgandroid.svg.SVGParseException
   {
      debug("<style>");
      ...
      for (int i=0; i<attributes.getLength(); i++)
      {
         ...
         {
            case type:
               isTextCSS = val.equals(com.aylar.svgandroid.svg.CSSParser.CSS_MIME_TYPE);
               break;
            case media:
               media = val;
               break;
      ...
      if (isTextCSS && com.aylar.svgandroid.svg.CSSParser.mediaMatches(media, MediaType.screen)) {
         inStyleElement = true;
      } else {
         ignoring = true;
         ignoreDepth = 1;
   ...
   {
      com.aylar.svgandroid.svg.CSSParser cssp = new com.aylar.svgandroid.svg.CSSParser(MediaType.screen, com.aylar.svgandroid.svg.CSSParser.Source.Document);
