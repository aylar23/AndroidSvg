...
{
   private com.aylar.svgandroid.svg.SVG svg = null;
   private com.aylar.svgandroid.svg.RenderOptions renderOptions = new RenderOptions();
   ...
   private void  init(AttributeSet attrs, int defStyle)
   {
      ...
      TypedArray a = getContext().getTheme()
                     .obtainStyledAttributes(attrs, com.aylar.svgandroid.R.styleable.SVGImageView, defStyle, 0);
      try
      {
         // Check for css attribute
         String  css = a.getString(com.aylar.svgandroid.R.styleable.SVGImageView_css);
         if (css != null)
            renderOptions.css(css);

         // Check whether svg attribute is a resourceId
         int  resourceId = a.getResourceId(com.aylar.svgandroid.R.styleable.SVGImageView_svg, -1);
         if (resourceId != -1) {
         ...
         String  url = a.getString(com.aylar.svgandroid.R.styleable.SVGImageView_svg);
         if (url != null)
         {
    ...
    * @since 1.2.1
    */
   public void  setSVG(com.aylar.svgandroid.svg.SVG svg)
   {
      if (svg == null)
    ...
    * @since 1.3
    */
   public void  setSVG(com.aylar.svgandroid.svg.SVG svg, String css)
   {
      if (svg == null)
         throw new IllegalArgumentException("Null value passed to setSVG()");
    ...
    */
    boolean  internalSetImageURI(Uri uri)
   {
      try
      {
    ...
    boolean  internalSetImageAsset(String filename)
   {
      try
      {
    ...
    void setFromString(String url)
   {
      try {
         this.svg = com.aylar.svgandroid.svg.SVG.getFromString(url);
         doRender();
   ...
   private class LoadResourceTask extends AsyncTask<Integer, Integer, com.aylar.svgandroid.svg.SVG>
   {
      ...
      protected com.aylar.svgandroid.svg.SVG doInBackground(Integer... params)
      {
         try
         {
            return com.aylar.svgandroid.svg.SVG.getFromResource(context, resourceId);
         }
         catch (SVGParseException e)
         {
      ...
      protected void  onPostExecute(com.aylar.svgandroid.svg.SVG svg)
      {
    ...
    class LoadURITask extends AsyncTask<InputStream, Integer, com.aylar.svgandroid.svg.SVG>
   {
      protected com.aylar.svgandroid.svg.SVG doInBackground(InputStream... is)
      {
         try
         {
            return com.aylar.svgandroid.svg.SVG.getFromInputStream(is[0]);
         }
         catch (SVGParseException e)
         {
