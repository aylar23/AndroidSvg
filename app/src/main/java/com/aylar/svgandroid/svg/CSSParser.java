...
import com.aylar.svgandroid.svg.CSSParseException;
...
import com.aylar.svgandroid.svg.SVGParser;
import com.aylar.svgandroid.svg.SVGParser.TextScanner;
...
class CSSParser
{
   ...
   */
   ...
   private static class CSSTextScanner extends TextScanner
   {
       ...
       */
      private List<Selector>  nextSelectorGroup() throws com.aylar.svgandroid.svg.CSSParseException
      {
         if (empty())
            return null;
       ...
       */
      boolean  nextSimpleSelector(Selector selector) throws com.aylar.svgandroid.svg.CSSParseException
      {
         if (empty())
            return false;
         ...
         while (!empty())
         {
            if (consume('.'))
            {
               ...
               if (value == null)
                  throw new com.aylar.svgandroid.svg.CSSParseException("Invalid \".class\" simpleSelectors");
            ...
            if (consume('#'))
            {
               ...
               String  value = nextIdentifier();
               if (value == null)
                  throw new com.aylar.svgandroid.svg.CSSParseException("Invalid \"#id\" simpleSelectors");
            ...
            if (consume('['))
            {
               ...
               if (attrName == null)
                  throw new com.aylar.svgandroid.svg.CSSParseException("Invalid attribute simpleSelectors");
               skipWhitespace();
               AttribOp  op = null;
               if (consume('='))
                  op = AttribOp.EQUALS;
      ...
      private AnPlusB  nextAnPlusB() throws com.aylar.svgandroid.svg.CSSParseException
      {
         if (empty())
            return null;
       ...
       * Eg. for :lang(en)
       */
      private List<String>  nextIdentListParam() throws com.aylar.svgandroid.svg.CSSParseException
      {
         if (empty())
            return null;
       ...
       */
      private List<Selector>  nextPseudoNotParam() throws com.aylar.svgandroid.svg.CSSParseException
      {
         if (empty())
            return null;
       ...
       */
      private void  parsePseudoClass(Selector selector, SimpleSelector selectorPart) throws com.aylar.svgandroid.svg.CSSParseException
      {
         // skip pseudo
//         int     pseudoStart = position;
         String  ident = nextIdentifier();
         if (ident == null)
            throw new com.aylar.svgandroid.svg.CSSParseException("Invalid pseudo class");
         ...
         switch (identEnum)
         {
            ...
            case nth_last_of_type:
               ...
               if (ab == null)
                  throw new com.aylar.svgandroid.svg.CSSParseException("Invalid or missing parameter section for pseudo class: " + ident);
            ...
            default:
               throw new com.aylar.svgandroid.svg.CSSParseException("Unsupported pseudo class: " + ident);
         }
...
//         simpleSelectors.addedAttributeOrPseudo();
   ...
   private void  parseAtRule(Ruleset ruleset, CSSTextScanner scan) throws com.aylar.svgandroid.svg.CSSParseException
   {
      String  atKeyword = scan.nextIdentifier();
      scan.skipWhitespace();
      if (atKeyword == null)
         throw new com.aylar.svgandroid.svg.CSSParseException("Invalid '@' rule");
      if (!inMediaRule && atKeyword.equals("media"))
      {
         List<MediaType>  mediaList = parseMediaList(scan);
         if (!scan.consume('{'))
            throw new com.aylar.svgandroid.svg.CSSParseException("Invalid @media rule: missing rule set");
         ...
         if (!scan.empty() && !scan.consume('}'))
            throw new com.aylar.svgandroid.svg.CSSParseException("Invalid @media rule: expected '}' at end of rule set");
      ...
      else if (!inMediaRule && atKeyword.equals("import"))
      {
         ...
         if (file == null)
            throw new com.aylar.svgandroid.svg.CSSParseException("Invalid @import rule: expected string or url()");
   ...
   private Ruleset  parseRuleset(CSSTextScanner scan)
   {
      ...
      catch (com.aylar.svgandroid.svg.CSSParseException e)
      {
   ...
   private boolean  parseRule(Ruleset ruleset, CSSTextScanner scan) throws com.aylar.svgandroid.svg.CSSParseException
   {
      List<Selector>  selectors = scan.nextSelectorGroup();
      if (selectors != null && !selectors.isEmpty())
      {
         if (!scan.consume('{'))
            throw new com.aylar.svgandroid.svg.CSSParseException("Malformed rule block: expected '{'");
         scan.skipWhitespace();
   ...
   private SVG.Style  parseDeclarations(CSSTextScanner scan) throws com.aylar.svgandroid.svg.CSSParseException
   {
      ...
      while (true)
      {
         ...
         scan.skipWhitespace();
         if (!scan.consume(':'))
            throw new com.aylar.svgandroid.svg.CSSParseException("Expected ':'");
         scan.skipWhitespace();
         String  propertyValue = scan.nextPropertyValue();
         if (propertyValue == null)
            throw new com.aylar.svgandroid.svg.CSSParseException("Expected property value");
         // Check for !important flag.
         scan.skipWhitespace();
         if (scan.consume('!')) {
            scan.skipWhitespace();
            if (!scan.consume("important")) {
               throw new com.aylar.svgandroid.svg.CSSParseException("Malformed rule set: found unexpected '!'");
            }
